...
export async function createUser(requestBody: UserCreateRequest): Promise<UserCreateResponse> {
    try {
...
export async function updateUserById(id: string, requestBody: UserUpdateRequest): Promise<void> {
...
export async function requestEmailVerification(username: string) {
...
export async function submitEmailVerification(requestBody: UserVerifyRequest) {
